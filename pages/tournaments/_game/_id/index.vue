  ...
  <div class="info">
    <div class="info__items">
      <div class="info__item">
        ...
        <div class="info__item-text">{{ tournament.startDate }}</div>
      </div>
      <div class="info__item">
        <div class="info__item-title">Game</div>
        <div class="info__item-text">{{ tournament.game }}</div>
      </div>
      <div class="info__item">
        <div class="info__item-title">Prize pool</div>
        <div class="info__item-text">{{ tournament.prizePool }}</div>
      </div>
      <div class="info__item" v-show="tournament.minAge !== 0">
        <div class="info__item-title">Additional requirements</div>
        <div class="info__item-text">At least {{ tournament.minAge }} years old</div>
      </div>
      <div class="info__item">
        <div class="info__item-title">Mode</div>
        <div class="info__item-text">{{ tournament.mode }} - {{ tournament.format }}</div>
        <div class="info__item-text">BO1 | Final BO3</div>
      </div>
      <div class="info__item" v-show="tournament.veto">
        <div class="info__item-title">Veto</div>
        <div class="info__item-text">{{ tournament.veto }}</div>
      </div>
      <div class="info__item" v-show="tournament.lobby">
        <div class="info__item-title">Lobby</div>
        <div class="info__item-text">{{ tournament.lobby }}</div>
      </div>
    </div>
